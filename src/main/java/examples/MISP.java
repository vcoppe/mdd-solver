...
public class MISP implements Problem {
	...
	class MISPState implements StateRepresentation {
		...
		public boolean equals(Object o) {
			...
			return this.bs.equals(((MISPState) o).bs);
		}
	...
	public static void main(String[] args) {
        ...
        try {
            Scanner scan = new Scanner(new File("data/misp/easy/johnson8-4-4.clq"));
        ...
        Solver solver = new Solver(new MISP(weights, complement),new MinLPMergeSelector(), new MinLPDeleteSelector(), new MISP.MISPVariableSelector());
